        ...
        <div class="col-md-12">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li class=""><a href="#tab_3" data-toggle="tab" aria-expanded="false">Hóa Đơn Điện Tử</a></li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_1">
                        <div class="row">
                            <div class="col-md-12">
                                <h4>@lang( 'invoice.all_your_invoice_schemes' ) <button type="button" class="btn btn-primary btn-modal pull-right" data-href="{{action('InvoiceSchemeController@create')}}" data-container=".invoice_modal">
                    ...
                    <div class="tab-pane" id="tab_3">
                        <div class="row">
                            <div class="col-md-12">
                                <h4>cấu hình hóa đơn điện tử </h4>
                            </div>
                            <div class="col-md-12">
                                {!! Form::open(['url' => action('InvoiceSchemeController@electronicBill'), 'method' => 'post',
                                'id' => 'electronic_nill','class' => 'form-group', 'files' => true ]) !!}
                                @component('components.widget', ['class' => 'box-primary'])
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            {!! Form::label('api_supplier', 'Nhà cung cấp:*') !!}
                                            <br> {!! Form::select('api_supplier', [ 'VNPT'=> 'VNPT',
                                            'MatBao' => 'Mắt bão',
                                            'FPT' => 'FPT',
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            {!! Form::label('api_username', 'Api User:*') !!}
                                            {!! Form::text('api_username', null, ['class' => 'form-control', 'required',
                                            'placeholder' => 'Tên tài khoản api của bạn.']); !!}
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            {!! Form::label('api_password', 'Api Password:*') !!}
                                            {!! Form::text('api_password', null, ['class' => 'form-control', 'required',
                                            'placeholder' => 'Mật khẩu tài khoản api của bạn.']); !!}
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            {!! Form::label('api_baseUrl', 'Api Base Url:*') !!}
                                            {!! Form::text('api_baseUrl', null, ['class' => 'form-control', 'required',
                                            'placeholder' => 'Đường dẫn kết nối api của bạn.']); !!}
                                        </div>
                                    </div>
                                    <button type="submit" value="submit" class="btn btn-primary pull-right">@lang('messages.save')</button>
                                </div>
                                @endcomponent
                                {!! Form::close() !!}
                            </div>
