<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        {!! Form::label('description', 'Kí hiệu:') !!}
        {!! Form::text('description', $brand->description, ['class' => 'form-control','placeholder' => 'Kí hiệu']); !!}
      </div>
      <div class="form-group">
        {!! Form::label('address', 'Địa chỉ:') !!}
        {!! Form::text('address', $brand->address, ['class' => 'form-control','placeholder' => 'Địa chỉ']); !!}
      </div>
