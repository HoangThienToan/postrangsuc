    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
          {{-- Add full screen button --}}
            <div class="btn-group">
                <button id="fullScreen" class="btn btn-success dropdown-toggle btn-flat pull-left m-8 btn-sm mt-10">
            ...
            @if (in_array('pos_sale', $enabled_modules))
                @can('sell.create')
                    <a href="{{ action('BuySellPosController@create') }}" title="@lang('sale.pos_sale')" data-toggle="tooltip"
