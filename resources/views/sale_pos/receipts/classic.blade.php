...
@if (false)
    ...
    <img src="{{ asset('/uploads/media/trongdong.jpg') }}"
        style="width: 75%; position: absolute; top: 20%; right: 14%; opacity: 0.3;">
    <div style="max-width: 90%; margin:10px auto !important; " class="font-sell">
        <div class="row">
            <!-- Logo -->
            @php
                // dd($receipt_details->contact);
                $date = date('d');
                $month = date('m');
                $year = date('Y');
                $time = date('H:i:s');
            ...
            <div
                ...
                <center>
                    <div>
                        <p style="font-size:14px"><b>HÓA ĐƠN BÁN HÀNG</b> <i>(BILL OF SALE)</i></p>
                        <p>
                        ...
                        <div>
                            ...
                            <p>
                                ...
                                @if (!empty($receipt_details->display_name))
                                    <b style="font-size: 14px;">{{ mb_strtoupper($receipt_details->display_name) }}</b>
                                @endif
                            </p>
            ...
            <div class="col-xs-12" style="padding: 0 0 10px 0">
                @if ($receipt_details->lines)
                    ...
                    <table class=" table-responsive table-bordered table-slim table-image">
                        <thead>
                            <tr>
                                <th class="text-center " width="13%">Loại hàng <i
                                        style="font-weight: normal">(Item)</i>
                                </th>
                                <th class="text-center " width="10%">SL <i style="font-weight: normal">(Quantity)</i>
                                </th>
                                <th class="text-center " width="10%">TL Tổng <i
                                        style="font-weight: normal">(Total)</i>
                                </th>
                                <th class="text-center " width="10%">TL hột <i
                                        style="font-weight: normal">(Weight)</i>
                                </th>
                                <th class="text-center " width="10%">TL vàng <i
                                        style="font-weight: normal">(Weight)</i>
                                </th>
                                ...
                                <th class="text-center " width="10%">Giá công <i
                                        style="font-weight: normal">(Labor)</i>
                                </th>
    ...
    <td class="text-right">
     {{ $receipt_details->all_due }}
        ...
        @endif
        <div>
            <div class="p-word between" style="height:120px; position: relative;">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p>
                                ...
                                @if (!empty($receipt_details->display_name))
                                    <b
                                        style="font-size: 20px;">{{ mb_strtoupper($receipt_details->display_name) }}</b>
                                @endif
                            </p>
                    ...
                    <table class=" table-responsive table-bordered table-slim table-image">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center " width="10%">SL <i
                                        style="font-weight: normal">(Quantity)</i>
                                </th>
                                <th class="text-center " width="10%">TL Tổng <i
                                        style="font-weight: normal">(Total)</i>
                                </th>
