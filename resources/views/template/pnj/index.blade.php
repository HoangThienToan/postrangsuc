...
<head>
    ...
    <link rel="stylesheet" href="../pnj-all/Bootstrap-css/bootstrap.min.css">
    <script src="../pnj-all/Bootstrap-js/bootstrap.min.js"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
    {{-- Slide Library --}}
    <link rel="stylesheet" href="../pnj-all/splide-4.0.7/dist/css/splide.min.css">
    <script type="module" src="../pnj-all/splide-4.0.7/dist/js/splide.min.js"></script>
    {{-- For zoom image --}}
    <link rel="stylesheet" href="../pnj-all/cssmdb/mdb.min.css">
    <script src="../pnj-all/jsmdb/mdb.min.js"></script>
    {{-- Onscroll library --}}
    <link rel="stylesheet" href="../pnj-all/aos-master/dist/aos.css">
    <script src="../pnj-all/aos-master/dist/aos.js"></script>
     {{-- Put link custom in the last to override library --}}
    <script type="module" src="../pnj-all/js/main.js"></script>
    <link rel="stylesheet" href="../pnj-all/css/pnjmain.css?v=2.0">
</head>
...
<body>
    <div class="">
        <header class="container">
            <div class="hide-mobile">
                <ul class="border-bottom d-flex align-items-center justify-content-between reset-li px-4">
                    ...
                    <li class="d-flex justify-content-center align-items-center">
                            <div class="w-20">
                                ...
                                <img src="../pnj-all/pnj-img/Vangta-removebg-preview.png" alt="">
                                </a>
                            </div>
                    </li>
                    <li class="d-flex align-items-center justify-content-center">
                ...
                <ul class="d-flex container justify-content-between align-items-center reset-li reset-ul px-4">
                    ...
                    <li class="col-lg-3">
                        <div class="d-flex align-items-center border bg-search border-white rounded-8">
        ...
        <div>
                    ...
                    <div class="splide__track">
                        <ul class="splide__list reset-li">
                            <li class="splide__slide"><img
                                    src="../pnj-all/pnj-img/ngaydoi88-1972x640-2__1_.png" alt="">
                            </li>
                            <li class="splide__slide"><img
                                    src="../pnj-all/pnj-img/combo-t7-1972_x_640_CTA.jpeg" alt="">
                            </li>
                            <li class="splide__slide"><img
                                    src="../pnj-all/pnj-img/PNJ_Fast_x_Ahamove-20230308T114624Z-001_1972x640LDP_CTA.jpeg"
                                    alt=""></li>
                            <li class="splide__slide"><img
                                    src="../pnj-all/pnj-img/ngaydoi88-1972x640-2__1_.png" alt="">
                            </li>
            ...
            <div class="hide-desktop overflow-auto">
                <div class="d-flex w-mobile">
                    <div class="m-1 w-5">
                        <img src="../pnj-all/pnj-img/qua-tang-494x247CTA.jpeg" alt=""
                            srcset="">
                    </div>
                    <div class="m-1 w-5">
                        <img src="../pnj-all/pnj-img/StylePNJ_494x247.jpeg" alt="" srcset="">
                    </div>
                    <div class="m-1 w-5">
                        <img src="../pnj-all/pnj-img/qua-tang-494x247CTA.jpeg" alt=""
                            srcset="">
            ...
            <div class="container">
                <div>
                    <div class="hide-mobile">
                        <div class="d-flex">
                            ...
                            <div class="m-2">
                                <img src="../pnj-all/pnj-img/StylePNJ_494x247.jpeg" alt=""
                                    srcset="">
                            </div>
                            <div class="m-2">
                                <img src="../pnj-all/pnj-img/qua-tang-494x247CTA.jpeg" alt=""
                                ...
                                <div class="splide__track h-full leftMobile">
                                    <ul class="splide__list">
                                        <li class="splide__slide">
                                            <img src="../pnj-all/pnj-img/trang-suc-vang.png"
                                                alt="">
                                            <span
                                                class='d-flex align-items-center justify-content-center text-center'>Nhẫn
                                                cưới</span>
                                        </li>
                                        <li class="splide__slide">
                                            <img src="../pnj-all/pnj-img/trang-suc-bac.png"
                                                alt="">
                                            <span
                                                class='d-flex align-items-center justify-content-center text-center'>Nhẫn
                                                kim
                                        ...
                                        <li class="splide__slide">
                                            <img src="../pnj-all/pnj-img/trang-suc-bac.png"
                                                alt="">
                                            <span
                                                class='d-flex align-items-center justify-content-center text-center'>Dây
                                                chuyền
                                                vàng</span>
                                        </li>
                                        <li class="splide__slide">
                                            <img src="../pnj-all/pnj-img/bong-tai-vang.png"
                                                alt="">
                                            <span
                                                class='d-flex align-items-center justify-content-center text-center'>Trang
                                                sức
                                                bạc</span>
                                        </li>
                                        <li class="splide__slide">
                                            <img src="../pnj-all/pnj-img/trang-suc-bac.png"
                                                alt="">
                                            <span
                                                class='d-flex align-items-center justify-content-center text-center'>Bông
                                                tai
                                                vàng</span>
                                        </li>
                                        <li class="splide__slide">
                                ...
                                <div class="splide__track">
                                    <ul class="splide__list h-brand">
                                        <li class="splide__slide" data-splide-interval="3000">
                                            <div>
                                                <div>
                                                    <img src="../pnj-all/pnj-img/style-t5-1200x1200.png"
                                                        alt="" class="rounded-img">
                                                </div>
                                                <div class="son-img shadow">
                                                    <img src="../pnj-all/pnj-img/pnj disney-01.png"
                                                        alt="">
                                                </div>
                                            </div>
                                        ...
                                        <li class="splide__slide" data-splide-interval="3000">
                                            <div>
                                                <div>
                                                    <img src="../pnj-all/pnj-img/block-brands-disney.png"
                                                        alt="" class="rounded-img">
                                                </div>
                                                <div class="son-img-2 shadow">
                                                    <img src="../pnj-all/pnj-img/style-logo_1.svg"
                                                        alt="">
                                                </div>
                                            </div>
                                        </li>
                                        <li class="splide__slide" data-splide-interval="3000">
                                            <div>
                                                <div>
                                                    <img src="../pnj-all/pnj-img/block-brands-watch.png"
                                                        alt="" class="rounded-img">
                                                </div>
                                                <div class="son-img-3 shadow">
                                                    <img src="../pnj-all/pnj-img/pnj-watch_1.svg"
                                                        alt="">
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <ul class="splide__list">
                                            <li class="splide__slide sales-gra">
                                                <div class="bg-image hover-zoom">
                                                    <img src="../pnj-all/pnj-img/sp-gbxmxmw002351-bong-tai-vang-trang-10k-dinh-da-ecz-pnj-1.png"
                                                        alt="">
                                                </div>
                                                <span
                                            ...
                                            <li class="splide__slide sales-gra">
                                                <div class='hover-zoom'>
                                                    <img src="../pnj-all/pnj-img/gnddddw003910-nhan-kim-cuong-vang-trang-14k-pnj.png"
                                                        alt="">
                                                </div>
                                                <span
                                                    class='text-center d-flex align-items-center justify-content-center'>Nhẫn
                                            ...
                                            <li class="splide__slide sales-gra">
                                                <div class='hover-zoom'>
                                                    <img src="../pnj-all/pnj-img/sp-gnatxmh000003-nhan-vang-14k-dinh-da-disney-pnj-tangled-1.png"
                                                        alt="">
                                                </div>
                                            ...
                                            <li class="splide__slide sales-gra">
                                                <div class=''>
                                                    <img src="../pnj-all/pnj-img/gldrwb60410.106-lac-tay-pnj-vang-trang-10k-dinh-da-ecz-01.png"
                                                        alt="">
                                                </div>
                                                <span
                    ...
                    <div class="d-flex align-items-center justify-content-center flex-col" data-aos='fade-up' data-aos-duration='1200'>
                        <div class="w-60">
                            <h3 class="m-2">Bộ sưu tập</h3>
                            <div>
                                <img src="../pnj-all/pnj-img/rapunzel-320.425.png" alt=""
                                    class="rounded-img shadow">
                            </div>
                        </div>
                        <div class="m-4 w-100">
                            <div class="splide d-flex justify-content-center align-items-center m-4"
                                id="splideCollections" aria-label="Placeholder Example">
                                <div class="position-relative">
                                    <div class="splide__arrows">
                                        <button
                                            class="splide__arrow splide__arrow--prev splide--arrow prevCollections">
                                            <i class="fa-solid fa-chevron-left"></i>
                                        </button>
                                        <button
                                            class="splide__arrow splide__arrow--next splide--arrow nextCollections">
                                            <i class="fa-solid fa-chevron-right"></i>
                                        </button>
                                    </div>
                                    <div class="splide__track">
                    ...
                    <div class="m-4" data-aos='fade-up' data-aos-duration='1200'>

                        <div>
                            <img src="../pnj-all/pnj-img/combo-t7-1972_x_640_CTA.jpeg" alt="">
                        </div>
                        <div>
                            ...
                            <div class="m-4">
                                <div class="splide d-flex justify-content-center align-items-center m-4"
                                    id="splideTradition" aria-label="Placeholder Example">
                                    <div class="position-relative">
                                        <div class="splide__arrows">
                                            <button class="splide__arrow splide__arrow--prev splide--arrow prev">
                                                <i class="fa-solid fa-chevron-left"></i>
                ...
                <div class="m-4" >
                    <div data-aos='fade-up' data-aos-duration='1200'>
                        <div>
                            <img src="../pnj-all/pnj-img/ngaydoi88-1972x640-2__1_.png" alt="">
                        </div>
                        <div>
                            <h3 class='m-2 text-center'>
                                Trang sức cưới
                            ...
                            <div>
                                <div class="m-4">
                                    <div class="splide d-flex justify-content-center align-items-center m-4"
                                        id="splideMarry" aria-label="Placeholder Example">
                                        <div class="position-relative">
                                            <div class="splide__arrows">
                                                <button class="splide__arrow splide__arrow--prev splide--arrow prev">
                                                    <i class="fa-solid fa-chevron-left"></i>
                    ...
                    <div data-aos='zoom-in' data-aos-duration='1200'>
                        <div>
                            <img src="../pnj-all/pnj-img/PNJ_Fast_x_Ahamove-20230308T114624Z-001_1972x640LDP_CTA.jpeg"
                                alt="">
                        </div>
                        <div>
                            <h3 class='m-2 text-center'>
                            ...
                            <div>
                                <div class="m-4">
                                    <div class="splide d-flex justify-content-center align-items-center m-4"
                                        id="splideEcz" aria-label="Placeholder Example">
                                        <div class="position-relative">
                                            <div class="splide__arrows">
                                                <button class="splide__arrow splide__arrow--prev splide--arrow prev">
                                                    <i class="fa-solid fa-chevron-left"></i>
                    ...
                    <div data-aos='zoom-in' data-aos-duration='1200'>
                        ...
                        <div>
                            ...
                            <div>
                                <div class="m-4">
                                    <div class="splide d-flex justify-content-center align-items-center m-4"
                                        id="splideBrace" aria-label="Placeholder Example">
                                        <div class="position-relative">
                                            <div class="splide__arrows">
                                                <button class="splide__arrow splide__arrow--prev splide--arrow prev">
                                                    <i class="fa-solid fa-chevron-left"></i>
                    ...
                    <div data-aos='fade-up' data-aos-duration='1200'>
                        ...
                        <div>
                            ...
                            <div>
                                <div class="m-4">
                                    <div class="splide d-flex justify-content-center align-items-center m-4"
                                        id="splideDisney" aria-label="Placeholder Example">
                                        <div class="position-relative">
                                            <div class="splide__arrows">
                                                <button class="splide__arrow splide__arrow--prev splide--arrow prev">
                                                    <i class="fa-solid fa-chevron-left"></i>
                    ...
                    <div data-aos='fade-up' data-aos-duration='1200'>
                        <div>
                            <img src="../pnj-all/pnj-img/watch-t8-fix_banner__CTA_.jpeg" alt="">
                        </div>
                        <div>
                            <h3 class='m-2 text-center'>Đồng hồ</h3>
                            <div>
                                <div class="m-4">
                                    <div class="splide d-flex justify-content-center align-items-center m-4"
                                        id="splideWatch" aria-label="Placeholder Example">
                                        <div class="position-relative">
                                            <div class="splide__arrows">
                                                <button class="splide__arrow splide__arrow--prev splide--arrow prev">
                                                    <i class="fa-solid fa-chevron-left"></i>
            ...
            <div class="container hide-mobile">
                <h3 class="m-2">Có thể bạn thích</h3>
                <div class="m-4">
                    <ul class="d-flex">
                        <li class="col-md-3">
                            <div class="hover-zoom">
                                <img src="../pnj-all/pnj-img/si0000a000002-hat-charm-xo-diy-pnjsilver-1.png"
                                    alt="">
                            </div>
                            <span class='text-center d-flex align-items-center justify-content-center'>Mặt dây chuyền
                                kim tiền <br> PN8987773763</span>
                        </li>
                        <li class="col-md-3">
                            <div class="hover-zoom">
                                <img src="../pnj-all/pnj-img/gnddddw003910-nhan-kim-cuong-vang-trang-14k-pnj.png"
                        ...
                        <li class="col-md-3">
                            ...
                            <span class='text-center d-flex align-items-center justify-content-center'>Hạt Charm xỏ DIY
                                <br> PN8987773763</span>
                        </li>
                        <li class="col-md-3">
                            <div class="hover-zoom">
                                <img src="../pnj-all/pnj-img/sixmxmw060313-hat-charm-bac-dinh-da-pnjsilver-hinh-qua-bi-1.png"
                                    alt="">
                            </div>
                            <span class='text-center d-flex align-items-center justify-content-center'>Nhẫn
                                vàng theo trend <br> PN8987773763</span>
        ...
        <div>
            ...
            <div class="bg-dark">
                <div class="d-flex justify-content-center align-items-center container">
                    <img src="../pnj-all/pnj-img/footer-img.jpeg" alt="" style="width: 92.6%">
                </div>
                <div class="d-flex justify-content-center align-items-center container">
                ...
                <div>
                    ...
                    <ul class="container d-flex">
                        <li class="position-absolute position-footer">
                            <div class="w">
                                <img src="../pnj-all/pnj-img/icon-circle-tragop.svg" alt="">
                            </div>
                        ...
                        <li class="position-absolute position-footer2">
                            <div class="w">
                                <img src="../pnj-all/pnj-img/PNJfast-Giaotrong3h-circleicon.svg"
                                    alt="">
                            </div>
                            <h4 class="text-dark fw-bold text-center">
                                Giao hàng nhanh
                        ...
                        <li class="position-absolute position-footer3">
                            <div class="w">
                                <img src="../pnj-all/pnj-img/icon-circle-nbv.svg" alt="">
                            </div>
                            <h4 class="text-dark fw-bold text-center">
                                Người bạn vàng
                            </h4>
            ...
            <div class="d-flex mt-4 flex-col">
                ...
                <div class="col-lg-8">
                    <div class="d-flex flex-col">
                        ...
                        <div class="col-lg-6 px-2">
                            <div class="mb-2">
                                <img src="../pnj-all/pnj-img/watch-t8-fix_banner__CTA_.jpeg"
                                    alt="" class="rounded-img">
                            </div>
                            <br>
                            <div>
            ...
            <div class="position-absolute navOpen bg-white offcanvas rounded-8 w-100" id="offcanvasNavbar">
                <div class="d-flex justify-content-end p-2">
                    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                        aria-label="Close" id="closeButton" onclick="closeNav()"></button>
                </div>
    ...
    <script>
        ...
        // btn.addEventListener('click', function() {
        //     closeNavJs.style.fontWeight = 'unset'
        // });
        ...
        // var off = document.getElementsByClassName('show');

        var toggleContainer = document.getElementById("offcanvasNavbar");
        // var toggleButton = document.getElementById("");

        // Bắt sự kiện click trên phần tử document

        // closeNavJs.addEventListener('click', function() {
        //     document.addEventListener("click", function(event) {
        //         // Kiểm tra xem phần tử được kích hoạt có thuộc #toggle-container hay không
        //         // console.log(!event.target.closest("#resetBar"));
        //         if (event.target !== toggleContainer) {
        //             console.log("Clicked outside of toggle container");
        //             // closeNavJs.click();
        //             // openNav(closeNavJs);
        //             openNav();
        //             // closeNavJs.classList.toggle("change");
        //             // Thực hiện hành động mong muốn khi người dùng kích vào phía bên ngoài #toggle-container
        //         }
        //     });
        // });
    </script>
