        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div id="more_div" class="hide">
                    ...
                    <div class="col-md-4 opening_balance" style="display: none;">
                        <div class="form-group">
                    ...
                    <div class="col-md-4 customer_fields">
                        <div class="form-group">
                            {!! Form::label('wages_due', 'Nợ tiền: ') !!}
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <i class="fas fa-money-bill-alt"></i>
                                </span>
                                {!! Form::text('wages_due', $contact->balance != null ? @num_format($contact->balance) : null, ['class' => 'form-control input_number']); !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 customer_fields">
                        <div class="form-group">
                            {!! Form::label('gold_due', 'Nợ vàng: ') !!}
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <i class="fas fa-money-bill-alt"></i>
                                </span>
                                {!! Form::text('gold_due', $contact->debt_gold != null ? @num_format($contact->debt_gold) : null, ['class' => 'form-control input_number']); !!}
                            </div>
                        </div>
                    </div>
