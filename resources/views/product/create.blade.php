  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <div class="form-group">
        ...
        {!! Form::number('weight', !empty($duplicate_product->weight) ? $duplicate_product->weight : null, ['class' => 'form-control required', 'placeholder' => __('lang_v1.total_weight')]); !!}
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
        {!! Form::label('seed_weight', __('lang_v1.seed_weight') . ':') !!}
        {!! Form::number('seed_weight', !empty($duplicate_product->seed_weight) ? $duplicate_product->seed_weight : null, ['class' => 'form-control', 'placeholder' => __('lang_v1.seed_weight')]); !!}
      </div>
    </div>
    <div class="col-sm-4" id='category_golden'>
      <div class="form-group">
        {!! Form::label('golden_age', __('lang_v1.golden_age') . ':') !!}
        {!! Form::number('golden_age', !empty($duplicate_product->golden_age) ? $duplicate_product->golden_age : null, ['class' => 'form-control', 'placeholder' => __('lang_v1.golden_age')]); !!}
      </div>
    </div>
    @php
