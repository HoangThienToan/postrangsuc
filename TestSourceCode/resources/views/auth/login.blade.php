...
<div class="login-form col-md-12 col-xs-12 right-col-content">
    ...
    <div class="tradingview-widget-container d-print-none">
        ...
        <div class="tradingview-widget-copyright"><a href="https://vn.tradingview.com" rel="noopener"
                target="_blank"><span class="blue-text"> Ticker Tape</span></a> bởi TradingView</div>
    ...
    <form method="POST" action="{{ route('login') }}" id="login-form">
        ...
        <div class="form-group">
            ...
            <!-- <button type="submit" class="btn btn-info" ><i class="fab fa-facebook-f"></i></button>
                <button type="submit" class="btn btn-info"><i class="fab fa-google-plus-g"></i></button>
                <button type="submit" class="btn btn-info"><i class="fas fa-phone"></i></button> -->
            <a href="{{ route('facebook.login') }}" class="margin-left-10 btn btn-facebook btn-user">
                <i class="fab fa-facebook-f fa-fw"></i>
            </a>
            <a href="{{ route('google.login') }}" class="margin-left-10 btn btn-google btn-user">
                <i class="fab fa-google-plus-g fa-fw"></i>
            </a>
            <a href="" class="margin-left-10 btn-info btn btn-user">
